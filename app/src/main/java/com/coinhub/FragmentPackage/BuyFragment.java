...
public class BuyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        /**
         * setting up the buy layout to this fragment
         */
        rootView = inflater.inflate(R.layout.layout_buy, container, false);
        return rootView;
    }


    /**
     * Demo API call for buy coin
     * just pass wallet id and userId and amount and price and changed json tags as your need.
     */
    private void apiCallForbuyCoin(final String walletId, final String userId, final String amount, final String price) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "Put your buy coin API url here", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {

                    /**
                     * demo json data parsing from buy coin api success response
                     */
                    /**
